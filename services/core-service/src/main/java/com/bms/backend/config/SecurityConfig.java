        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/auth/signup", "/api/v1/auth/login",
                                       ...
                                       "/api/v1/auth/otp/send-email", "/api/v1/auth/otp/send-phone",
                                       "/api/v1/auth/otp/verify-email", "/api/v1/auth/otp/verify-phone",
                                       "/api/v1/auth/login/send-otp", "/api/v1/auth/login/verify-otp",
